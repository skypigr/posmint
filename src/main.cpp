...
unsigned int nStakeMinAge = 60 * 20;	// minimum age for coin age: 20d
...
int64 nChainStartTime = 1406156000;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "New Mint Test 07-24-2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x1822a9ab878cce6fd1b3f4a91135a8728dd5adeb0b02cba364c699ae5e216c81"));
